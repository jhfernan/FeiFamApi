						...
						<body class="mt-5" style="background-color: #343A40;">
							<div class="container pb-3 text-center">
								<div class="jumbotron bg-white">
									<h1 class="mb-5">New Submission from Request a Quote</h1>
									<table class="table table-hover">
										<tbody class="text-left">
											...
											<tr>
												<th>Business Name</th>
												<td>${ info.nameBusiness || '' }</td>
											</tr>
											<tr>
												<th style="vertical-align: middle;">Contact Info</th>
												<td>${ info.email }<br />${ info.phone }</td>
											</tr>
											<tr>
												<th>Project Type</th>
												<td>${ info.type }</td>
											...
											<tr>
												...
												<td>${ info.description || 'No description given' }</td>
											</tr>
											<tr>
											...
											<tr>
												<th>Ideal Due Date</th>
												<td>${ info.date || '' }</td>
											</tr>
											<tr>
												<th style="vertical-align: middle;">Special Notes/Considerations</th>
												<td>${ info.notes || 'None given' }</td>
											</tr>
										</tbody>
									</table>
									<div class="mt-5">
